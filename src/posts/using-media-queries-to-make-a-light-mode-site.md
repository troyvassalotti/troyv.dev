...
![What my site looks like without any sort of color scheme emulation, a dark color scheme, and a light color scheme]({{ metadata.cloudinary.image }}/c_scale,f_auto,q_auto:eco/v1646349103/blog/mobile-all-three_fcgn17.webp)
...
![What my site looks like without any sort of color scheme emulation, a dark color scheme, and a light color scheme]({{ metadata.cloudinary.image }}/c_scale,f_auto,q_auto:eco/v1646349103/blog/light-palette_d5nd2i.webp)
...
![WMy light mode website]({{ metadata.cloudinary.image }}/c_scale,f_auto,q_auto:eco/v1646349103/blog/light-mode_qayeyh.jpg)
