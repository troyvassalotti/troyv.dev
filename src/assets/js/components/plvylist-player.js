class Plvylist extends HTMLElement {
  constructor() {
    ...
    this.tracks = [
      {
        file:
          this.getAttribute("audio-location") + "01_I_Know_I'm_Not.mp3" || "",
      ...
      {
        file:
          this.getAttribute("audio-location") +
          "07_Alone_In_a_Crowded_Room.mp3",
      ...
      },
      {
        file:
          this.getAttribute("audio-location") +
          "08_Long_Time_Caller_First Time List.mp3",
      ...
      },
      {
        file:
          this.getAttribute("audio-location") +
          "10_We_Can't_Rush_These_Things.mp3",
      ...
      },
      {
        file:
          this.getAttribute("audio-location") +
          "12_Like_Drowning_(Bonus_Track).mp3",
    ...
    shadowRoot.innerHTML = `
            <style>
                .container {
                    ...
                    --color-base: var(--blackPrimary);
                    --color-layout: var(--whitePrimary);
                    --color-contrast-1: var(--grayPrimary);
                    --color-contrast-2: var(--goldPrimary);
                    --track-width: 100%;
                    --track-height: .25em;
                    ...
                    --font-family: "Native", Monospace, monospace;
